...
export class CS2InventoryInstance {
    ...
    private toBaseInventoryItem({ props, storage, uid, ...value }: CS2InventoryItem): CS2BaseInventoryItem {
        return {
            ...value,
    ...
    equip(itemUid: number, team?: CS2TeamValues): this {
        ...
        assert(CS2_INVENTORY_EQUIPPABLE_ITEMS.includes(item.props.type));
