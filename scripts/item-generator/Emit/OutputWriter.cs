    ...
    public static async Task EmitOutputs(ItemGeneratorContext ctx)
    {
        var items = ctx.Items.Values
            ...
            .Select(i => new CS2Item
            {
                ...
                KeychainPositionXMax = i.KeychainPositionXMax,
                KeychainPositionXMin = i.KeychainPositionXMin,
                KeychainPositionYMax = i.KeychainPositionYMax,
                KeychainPositionYMin = i.KeychainPositionYMin,
                KeychainPositionZMax = i.KeychainPositionZMax,
                KeychainPositionZMin = i.KeychainPositionZMin,
                KeyIds = i.KeyIds,
                LegacyKeychainPositionXMax = i.LegacyKeychainPositionXMax,
                LegacyKeychainPositionXMin = i.LegacyKeychainPositionXMin,
                LegacyKeychainPositionYMax = i.LegacyKeychainPositionYMax,
                LegacyKeychainPositionYMin = i.LegacyKeychainPositionYMin,
                LegacyKeychainPositionZMax = i.LegacyKeychainPositionZMax,
                LegacyKeychainPositionZMin = i.LegacyKeychainPositionZMin,
